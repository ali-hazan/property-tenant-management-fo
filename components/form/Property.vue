<template>
  <div>
    <el-form ref="formRef" :model="form" label-width="120px" label-position="top">
      <el-row>
        <el-col :span="11">
          <el-form-item label="Property ID" prop="propertyId"
      ...
      <el-row>
        <el-col :span="11">
          <el-form-item label="Status" prop="status" :rules="[{ required: true, message: 'Status is required' }]">
            <el-select v-model="form.status">
              <el-option v-for="(status, key) in Enum_Property_Status" :key="status" :label="key" :value="status" />
            </el-select>
          </el-form-item>
        </el-col>
        <el-col :span="1" />
        <el-col :span="11">
          <el-form-item label="Property Type" prop="type"
            :rules="[{ required: true, message: 'Property type is required' }]">
            <el-select v-model="form.type">
              <el-option v-for="(type, key) in Enum_Property_Type" :key="type" :label="key" :value="type" />
            </el-select>
          </el-form-item>
        </el-col>
      </el-row>
      <el-form-item label="No. of Tenant" prop="numberOfTenant"
